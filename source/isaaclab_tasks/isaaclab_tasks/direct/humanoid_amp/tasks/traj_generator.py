...
class TrajGenerator:
    def __init__(
        ...
        # env_ids = torch.arange(self.get_num_envs(), dtype=torch.int32)
    ...
    def reset(self, env_ids, init_pos):
        ...
        if n > 0:
            ...
            print(f"verts.shape: {self._verts.shape}============================================")
    ...
    def input_new_trajs(self, env_ids):
        ...
        raise NotImplementedError("Input new trajs not implemented")
